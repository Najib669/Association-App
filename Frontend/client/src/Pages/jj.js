    ...
    <Form className='fourma'>
     ...
     <div className='order resume'>
      {cartItems.map((item) => (
        ...
        <Col sm={10}>
          <Form.Control style={{backgroundColor : 'rgba(219, 255, 173, 0.634)'}} type="shipping-adress" placeholder="Shipping Adress"
           name='shippingAdress'  onChange={handleChange}/>
        </Col>
      </Form.Group>
      ...
      <Form.Group as={Row} className="mb-3" controlId="formHorizontalPassword">
        ...
        <Col  sm={10}>
          <Form.Control style={{backgroundColor : 'rgba(219, 255, 173, 0.634)'}} type="phone-number" placeholder="Phone Number"
...
:
<></>}
    <button className='confirm-order-button' onClick={handleOrder}>Comfirm</button>
